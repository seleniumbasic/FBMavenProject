...
public class TC005 
{
	...
	public void browserOpen(String browsername) throws Exception
	{
		 ...
		 * ChromeDriver(); }else if(browsername.equalsIgnoreCase("ie")) {
		 * System.setProperty("webdriver.ie.driver",
		 * System.getProperty("user.dir")+"/drivers/IEDriverServer.exe"); driver = new
		 * InternetExplorerDriver(); }else if(browsername.equalsIgnoreCase("firefox")) {
		 * System.setProperty("webdriver.gecko.driver",
		 * System.getProperty("user.dir")+"/drivers/geckodriver.exe"); driver = new
		 * FirefoxDriver(); }else { System.out.println(browsername + " is invalid");
